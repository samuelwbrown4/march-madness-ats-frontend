            ...
            <div id="landing-page">
                ...
                <div className="league-sign-in">
                    ...
                    <form className="league-sign-in-form" onSubmit={(e) => handleLeagueNameSubmit(e)}>
                        <input type="text" className="form-control" placeholder="Enter league name..." id="league-sign-in-input" value={leagueId} onChange={e => setLeagueId(e.target.value)}></input>
                        <button className='btn btn-primary' id="go-to-bracket-btn" type="submit">Go<svg className="button-svg" width="30px" height="30px" viewBox="0 0 30 30" fill="#currentColor" xmlns="http://www.w3.org/2000/svg">
